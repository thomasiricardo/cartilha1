...
// include: C:\Users\USUARIO\AppData\Local\Temp\tmp2knnt7kq.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'C:/Cartilha_PD/Patch2a_cart_/WebPatch/pd4web.data';
...
Module['FS_createPath']("/", "Libs", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_C:/Cartilha_PD/Patch2a_cart_/WebPatch/pd4web.data');

      };
      Module['addRunDependency']('datafile_C:/Cartilha_PD/Patch2a_cart_/WebPatch/pd4web.data');
    ...
    loadPackage({"files": [{"filename": "/Libs/any2symbol.pd", "start": 0, "end": 1703}, {"filename": "/Libs/display.pd", "start": 1703, "end": 14677}, {"filename": "/Libs/f2s~.pd", "start": 14677, "end": 15963}, {"filename": "/Libs/float2sig.unit.pd", "start": 15963, "end": 16238}, {"filename": "/Libs/free.rev~.pd", "start": 16238, "end": 38027}, {"filename": "/Libs/phasor.pd", "start": 38027, "end": 41925}, {"filename": "/index.pd", "start": 41925, "end": 57839}], "remote_package_size": 57839});

  })();

// end include: C:\Users\USUARIO\AppData\Local\Temp\tmp2knnt7kq.js
// include: C:\Users\USUARIO\AppData\Local\Temp\tmp1ls1ihf4.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\USUARIO\AppData\Local\Temp\tmp1ls1ihf4.js
// include: C:\Users\USUARIO\AppData\Local\Temp\tmpj38sq73q.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\USUARIO\AppData\Local\Temp\tmpj38sq73q.js
